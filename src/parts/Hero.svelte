...
<section class="hero" in:fade={{ duration: 200 }}>
  <div class="hero__left">
    <a href="https://github.com/rndytech">
      <img
        class="hero__pict"
  ...
  <div class="hero__right">
    <span class="hero__greet">Hi, I'm</span>
    <span class="hero__name"> Randi Ramli. </span>
    <span class="hero__role">A Frontend Developer and I love Open Source!</span>
    <p class="hero__desc">
      I'm a 17 years old from Indonesia. I love making random websites and
      contribute to any open source projects that I like. I also love Anime and
      electrical Engineering, such perfect combination to lose your life eh? ツ
    </p>
